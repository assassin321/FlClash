...
void main(List<String> arguments) async {
  ...
  final outputBaseName = 'FlClash-$appVersion-windows-$desc-setup';
  ...
  final coreExecutableName = isDev ? 'FlClashDevCore.exe' : 'FlClashCore.exe';
  final helperExecutableName = isDev ? 'FlClashDevHelperService.exe' : 'FlClashHelperService.exe';
  final helperServiceName = isDev ? 'FlClashDevHelperService' : 'FlClashHelperService';
  final taskName = isDev ? 'FlClash Dev' : 'FlClash';
  ...
  final variables = {
    ...
    'INSTALL_DIR_NAME': '{autopf64}\\${makeConfig['display_name'] ?? 'FlClash'}',
