...
#ifdef FLCLASH_DEV
constexpr const wchar_t kAppUserModelId[] = L"Appshub.FlClash.Dev";
#else
constexpr const wchar_t kAppUserModelId[] = L"Appshub.FlClash";
#endif
...
static LONG WINAPI FlClashUnhandledExceptionFilter(
  ...
  filename << dir << L"\\flclash_" << ms << L".dmp";
...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  ::SetUnhandledExceptionFilter(FlClashUnhandledExceptionFilter);
...
#ifdef FLCLASH_DEV
  const wchar_t *window_title = L"FlClash Dev";
#else
  const wchar_t *window_title = L"FlClash";
#endif
