...
class FlClashService : Service(), BaseServiceInterface {
    ...
    private val fairMemoryHelper = FairMemoryHelper("FlClashService")
    ...
    inner class LocalBinder : Binder() {
        fun getService() = this@FlClashService
    }
    ...
    override fun stop() {
        ...
        }.onFailure { android.util.Log.e("FlClashService", "Failed to stop foreground: ${it.message}") }

        runCatching {
            getSystemService(android.app.NotificationManager::class.java)
                ?.cancel(GlobalState.NOTIFICATION_ID)
        }.onFailure { android.util.Log.e("FlClashService", "Failed to cancel notification: ${it.message}") }
    ...
    private suspend fun notificationBuilder() =
        cachedBuilder ?: createFlClashNotificationBuilder().also { cachedBuilder = it }
