...
import com.assassin321.flclash.core.Core
import com.assassin321.flclash.extensions.awaitResult
import com.assassin321.flclash.extensions.asSocketAddressText
import com.assassin321.flclash.extensions.resolveDns
import com.assassin321.flclash.models.StartForegroundParams
import com.assassin321.flclash.models.VpnOptions
import com.assassin321.flclash.modules.SuspendModule
import com.assassin321.flclash.services.BaseServiceInterface
import com.assassin321.flclash.services.FlClashService
import com.assassin321.flclash.services.FlClashVpnService
...
data object VpnPlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
            ...
            try {
                if (options?.enable == true) {
                    val prepareIntent = try {
                        android.net.VpnService.prepare(FlClashApplication.getAppContext())
                    } catch (e: Exception) {
                        null
                    }
    ...
    private suspend fun performStartCore(
        ...
        com.assassin321.flclash.core.Core.startTun(
            fd = fd ?: 0,
        ...
        GlobalState.runLock.withLock {
            ...
            if (currentOptions.dozeSuspend) {
                ...
                suspendModule = SuspendModule(FlClashApplication.getAppContext())
    ...
    fun handleSmartStop() {
        ...
        scope.launch(Dispatchers.Main) {
            Toast.makeText(FlClashApplication.getAppContext(), "FlClash Suspended", Toast.LENGTH_SHORT).show()
        }
        ServicePlugin.notifyNetworkChanged()
    }
