...
import com.assassin321.flclash.extensions.getIpv4RouteAddress
import com.assassin321.flclash.extensions.getIpv6RouteAddress
import com.assassin321.flclash.extensions.toCIDR
import com.assassin321.flclash.models.AccessControlMode
import com.assassin321.flclash.models.VpnOptions
import com.assassin321.flclash.plugins.VpnPlugin
...
class FlClashVpnService : VpnService(), BaseServiceInterface {
    companion object {
        private const val TAG = "FlClashVpnService"
    }
    ...
    private suspend fun notificationBuilder(): NotificationCompat.Builder {
        if (cachedBuilder == null) {
            cachedBuilder = createFlClashNotificationBuilder()
        }
    ...
    override suspend fun startForeground() {
        ...
        lastNotificationText = null
        val builder = createFlClashNotificationBuilder(isSuspended, isHighPriority)
