...
import com.appshub.flclash.plugins.AppPlugin
import com.appshub.flclash.plugins.ServicePlugin
import com.appshub.flclash.plugins.TilePlugin
import com.appshub.flclash.plugins.VpnPlugin
import com.appshub.flclash.services.FlClashTileService
...
object GlobalState {
    ...
    const val NOTIFICATION_CHANNEL_HIGH = "FlClash_High"
    const val NOTIFICATION_CHANNEL_SUSPENDED = "FlClash_Suspended"
    ...
    private val tileRetryRunnable = Runnable {
        FlClashTileService.refreshActive()
    ...
    private fun requestListeningStateSafely() {
        runCatching {
            ...
            TileService.requestListeningState(
                context,
                ComponentName(context, FlClashTileService::class.java)
            )
        }.onFailure {
    ...
    fun isCurrentlyStopping(): Boolean {
        ...
        return runCatching {
            val sp = FlClashApplication.getAppContext()
                .getSharedPreferences("vpn_state", android.content.Context.MODE_PRIVATE)
    ...
    fun initServiceEngine(flags: List<String>? = null) {
        runLock.withLock {
            ...
            val app = FlClashApplication.getAppContext() as FlClashApplication
